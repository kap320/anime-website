  ...
  return (
    <footer className="border-t-[1px] bg-slate-800 border-slate-200 flex-col flex w-full py-9 justify-center items-center">
      <div className="flex gap-3 w-full items-center justify-center mb-3">
        <a href="https://github.com/shanachanpanel" className="rounded-full p-2 z-10 overflow-hidden relative border-[1px] md:p-3 after:content-[''] after:w-full after:absolute after:bottom-0 after:left-0 after:block after:h-0 after:bg-yellow-300 after:transition-all after:duration-300 after:ease-in-out hover:after:h-full after:-z-10">
          <img src={github} alt="github" className="w-3 sm:w-5 " />
        </a>
        <a href="https://instagram.com/shallownime/" className="rounded-full p-2 z-10 overflow-hidden relative border-[1px] md:p-3 after:content-[''] after:w-full after:absolute after:bottom-0 after:left-0 after:block after:h-0 after:bg-yellow-300 after:transition-all after:duration-300 after:ease-in-out hover:after:h-full after:-z-10">
          <img src={instagram} alt="instagram" className="w-3 sm:w-5  " />
        </a>
        <a href="https://nyaweria.com/@rizaedtz01" className="rounded-full p-2 z-10 overflow-hidden relative border-[1px] md:p-3 after:content-[''] after:w-full after:absolute after:bottom-0 after:left-0 after:block after:h-0 after:bg-yellow-300 after:transition-all after:duration-300 after:ease-in-out hover:after:h-full after:-z-10">
          <img src={linkedin} alt="linkedin" className="w-3 sm:w-5  " />
        </a>
        <a href="https://facebook.com/shanachan" className="rounded-full p-2 z-10 overflow-hidden relative border-[1px] md:p-3 after:content-[''] after:w-full after:absolute after:bottom-0 after:left-0 after:block after:h-0 after:bg-yellow-300 after:transition-all after:duration-300 after:ease-in-out hover:after:h-full after:-z-10">
